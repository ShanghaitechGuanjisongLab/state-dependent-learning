...
model_save_path = parameters.experiment4_hitmiss_modelOut_dir
...
for cur in os.listdir(model_save_path):
    ...
    print("model acc: ", normal_performance)
...
df.to_csv(os.path.join(parameters.experiment4_hitmiss_csvout_dir, r"crop1_hitmiss_sample{}_layer{}_weightdeacy{}_lr{}_drop{}_std{}.csv"
