...
model_save_path = parameters.experiment2_facr_modelOut_dir
...
for mouseid in mouseid_list:
    ...
    for _, downsample_train_index in kf.split(samples_toKfold):
        ...
        lr = 0.0001
        weight_decay=0.025
        modelSave = os.path.join(model_save_path, r"mouseid{}_crop1_facr_sample{}_layer{}_weightdeacy{}_lr{}_drop{}_std{}.pt"
        ...
        df.to_csv(os.path.join(parameters.experiment2_facr_csvout_dir, r"mouseid{}_crop1_facr_sample{}_layer{}_weightdeacy{}_lr{}_drop{}_std{}.csv"
                                .format(mouseid, sample_num, layers, weight_decay, lr, dropout, std)))
        sample_num +=1
