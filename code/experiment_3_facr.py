...
# experiment path
exp_positive_mat = parameters.exp_CNO_CR_matfile
exp_negative_mat = parameters.exp_CNO_FA_matfile
...
for _, downsample_train_index in kf.split(samples_toKfold):
    ...
    df.to_csv(os.path.join(parameters.experiment3_facr_csvout_dir, r"crop1_facr_sample{}_layer{}_weightdeacy{}_lr{}_drop{}_std{}.csv"
